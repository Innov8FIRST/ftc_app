...
@Autonomous(name = "A_Innov8_Relic_BlueeeStraight", group = "Auto")

public class A_Innov8_Relic_BlueeeStraight extends LinearOpMode {
            ...
            switch (taskNumber) {
                ...
                case 6: // Moving the robot forward if it previously moved forward - Same for both teams
                       ...
                       case 7: // turning right
                            ...
                            endPositionR = startPositionR + 600;
                ...
                case 9:// turning left to cryptobox
                    startPositionR = robot.rightMotor.getCurrentPosition();
                    endPositionR = startPositionR - 700;
                    while (opModeIsActive() && robot.rightMotor.getCurrentPosition() >= endPositionR) {
                ...
                case 11: //moving backwards
                    startPositionR = robot.rightMotor.getCurrentPosition();
                    endPositionR = startPositionR + 400;
                    while (opModeIsActive() && robot.rightMotor.getCurrentPosition() < endPositionR) {
